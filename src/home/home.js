  ...
  return (
    <main className='App-main'>
        <div className='pokemonsCartas'>
            <h1 style={{color:"white"}} className="pokemonsCartas-title">DISCOVER THE POKEMON WORLD</h1>
        ...
        <h1 style={{color:"white"}} className="sectionTitle2">KNOW EVERYTHING ABOUT POKEMONS, THEIR LIFES ATTACKS, TYPES, EVOLUTIONS AND SO MANY MORE THINGS</h1>
        ...
        <div className='section3'>
            <h1 style={{color:"white"}} className="pokemonsCartas-title2">DO YOU WANT TO PLAY <i>"WHO'S THAT POKEMON"</i> ?</h1>
